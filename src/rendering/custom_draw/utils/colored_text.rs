...
use crate::rendering::hibou_color_palette::HCP_White;
...
pub fn new_image_with_colored_text(path : &Path, alignment : &DrawnColoredTextAlignment, img_width : f32, img_height : f32, text_lines : Vec<Vec<TextToPrint>>) {
    // Draw Frame
