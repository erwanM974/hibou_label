...
use crate::rendering::custom_draw::multitrace::ext_mu::extract_texts_on_multi_trace;
use crate::rendering::custom_draw::utils::colored_text::{DrawnColoredTextAlignment, new_image_with_colored_text};
use crate::rendering::sd_drawing_conf::{FONT_WIDTH, MARGIN, VERTICAL_SIZE};
...
pub fn draw_multitrace(gen_ctx : &GeneralContext,
    ...
    // ***
    let mut text_lines : Vec<Vec<TextToPrint>> = extract_texts_on_multi_trace(gen_ctx,multi_trace,is_simulation,sim_crit_loop,sim_crit_act);
    // ***
    // ***
