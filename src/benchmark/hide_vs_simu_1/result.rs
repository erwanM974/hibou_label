...
pub struct AnalysisBenchResult {
    ...
    pub num_nodes_goal_none : Option<u32>,
    pub num_nodes_goal_wp : u32
}

impl AnalysisBenchResult {
    pub fn new(verdict : GlobalVerdict,
               num_nodes_goal_none : Option<u32>,
               num_nodes_goal_wp : u32) -> AnalysisBenchResult {
        return AnalysisBenchResult{verdict,num_nodes_goal_none,num_nodes_goal_wp};
    }
    ...
    pub fn to_csv_line(&self) -> String {
        ...
        match self.num_nodes_goal_none.as_ref() {
            None => {
                csv_line.push_str( "NA" );
                csv_line.push_str( CSV_SEP );
            },
            Some( nn ) => {
                csv_line.push_str( &nn.to_string() );
                csv_line.push_str( CSV_SEP );
            }
        }
...
impl HVSBenchResult  {
    ...
    pub fn get_csv_header(gen_ctx:&GeneralContext, initial_multi_trace : &AnalysableMultiTrace) -> String {
        ...
        csv_line.push_str( CSV_SEP );
        csv_line.push_str( "search_space_size_hide" );
        csv_line.push_str( CSV_SEP );
        ...
        csv_line.push_str( CSV_SEP );
        csv_line.push_str( "search_space_size_simu" );
        csv_line.push_str( CSV_SEP );
