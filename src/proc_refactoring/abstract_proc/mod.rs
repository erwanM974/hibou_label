...
use crate::process::hibou_process::{FilterEliminationKind, HibouSearchStrategy};
...
pub trait AbstractConfiguration : Sized {
    ...
    type PrioritiesConf : AbstractPrioritiesConf;
    type Filter : AbstractFilter<Self>;
    type FilterCriterion;
}

pub trait AbstractPrioritiesConf : Sized {
...
pub trait AbstractStepKind<Config : AbstractConfiguration> : Sized {
    ...
    fn get_priority(&self, process_priorities : &Config::PrioritiesConf) -> i32;
...
pub struct GenericProcessManager<Config : AbstractConfiguration> {
    ...
    priorities : Config::PrioritiesConf,
...
impl<Config : AbstractConfiguration> GenericProcessManager<Config> {
    ...
    pub fn new(gen_ctx : GeneralContext,
               ...
               priorities : Config::PrioritiesConf,
               memorized_states : HashMap<u32,GenericNode<Config>>,
               process_queue : Vec<GenericStep<Config>>) -> GenericProcessManager<Config> {
        return GenericProcessManager{gen_ctx,strategy,filters,priorities,memorized_states,process_queue};
    }
