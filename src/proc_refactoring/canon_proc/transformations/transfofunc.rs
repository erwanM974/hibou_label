...
use crate::proc_refactoring::canon_proc::transformations::total_order::interaction_lower_than;


pub(in crate::proc_refactoring::canon_proc) fn simpl_left(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
...
pub(in crate::proc_refactoring::canon_proc) fn simpl_right(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
        &Interaction::Strict(ref i1, ref i2) => {
...
pub(in crate::proc_refactoring::canon_proc) fn flush_right(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
...
pub(in crate::proc_refactoring::canon_proc) fn flush_left(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
        &Interaction::Alt(ref i1, ref i2) => {
            match **i2 {
...
pub(in crate::proc_refactoring::canon_proc) fn invert_alt_conditional(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
        &Interaction::Alt(ref i1, ref i2) => {
...
pub(in crate::proc_refactoring::canon_proc) fn invert_par_conditional(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
        &Interaction::Par(ref i1, ref i2) => {
            if interaction_lower_than(i2,i1) {
...
pub(in crate::proc_refactoring::canon_proc) fn tri_invert_alt_conditional_right_flushed(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
...
pub(in crate::proc_refactoring::canon_proc) fn tri_invert_par_conditional_right_flushed(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
...
pub(in crate::proc_refactoring::canon_proc) fn deduplicate(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
        &Interaction::Alt(ref i1, ref i2) => {
            if i1 == i2 {
                return Some( *i1.clone() );
...
pub(in crate::proc_refactoring::canon_proc) fn tri_deduplicate_right_flushed(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
        &Interaction::Alt(ref i1, ref i_right) => {
            match **i_right {
                Interaction::Alt(ref i2,ref i3) => {
...
pub(in crate::proc_refactoring::canon_proc) fn factorize_prefix_strict(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
        &Interaction::Alt(ref i1, ref i2) => {
...
pub(in crate::proc_refactoring::canon_proc) fn factorize_prefix_seq(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
        &Interaction::Alt(ref i1, ref i2) => {
...
pub(in crate::proc_refactoring::canon_proc) fn factorize_prefix_par(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
        &Interaction::Alt(ref i1, ref i2) => {
...
pub(in crate::proc_refactoring::canon_proc) fn factorize_suffix_strict(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
        &Interaction::Alt(ref i1, ref i2) => {
            let mut left_strict_frags = get_recursive_strict_frags(i1);
            let mut right_strict_frags = get_recursive_strict_frags(i2);
...
pub(in crate::proc_refactoring::canon_proc) fn factorize_suffix_seq(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
        &Interaction::Alt(ref i1, ref i2) => {
            let mut left_seq_frags = get_recursive_seq_frags(i1);
            let mut right_seq_frags = get_recursive_seq_frags(i2);
...
pub(in crate::proc_refactoring::canon_proc) fn factorize_suffix_par(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
        &Interaction::Alt(ref i1, ref i2) => {
            let mut left_par_frags = get_recursive_par_frags(i1);
            let mut right_par_frags = get_recursive_par_frags(i2);
...
pub(in crate::proc_refactoring::canon_proc) fn defactorize_left(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
        &Interaction::Strict(ref i1, ref i2) => {
            match **i2 {
                Interaction::Alt(ref i21, ref i22) => {
...
pub(in crate::proc_refactoring::canon_proc) fn defactorize_right(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
        &Interaction::Strict(ref i1, ref i2) => {
            match **i1 {
                Interaction::Alt(ref i11, ref i12) => {
...
pub(in crate::proc_refactoring::canon_proc) fn loop_simpl(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
...
pub(in crate::proc_refactoring::canon_proc) fn loop_unnest(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
...
pub(in crate::proc_refactoring::canon_proc) fn sort_emission_targets(interaction : &Interaction) -> Option<Interaction> {
    match interaction {
