...
pub fn transfo_factorize_prefix_strict(interaction : &Interaction) -> Vec<Interaction> {
    match interaction {
...
pub fn transfo_factorize_prefix_seq(interaction : &Interaction) -> Vec<Interaction> {
    match interaction {
        &Interaction::Alt(ref i1, ref i2) => {
