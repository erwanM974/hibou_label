...
This exploration can be modified by setting priorities for the treatment of child nodes with the "priorities" option. 
We will talk more about that in a specific example.
